        ...
        <div className="lg:col-span-1">
          ...
          <div className="flex gap-3 mt-6">
            <a
              ...
              className="w-11 h-11 rounded-full border border-[#D4A843]/30 flex items-center justify-center text-[#D4A843] hover:bg-[#D4A843] hover:text-[#1C1C1C] transition-all duration-300"
            >
              {/* Instagram icon SVG */}
